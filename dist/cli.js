#! /usr/bin/env node
import { g as getDefaultExportFromCjs, _ as _asyncToGenerator, a as _regeneratorRuntime, b as _ } from './swagger-mock-validator-Q-SmJB2B.js';
...
import { p as packageJson, S as SwaggerMockValidatorFactory } from './swagger-mock-validator-factory-DvSlBV0t.js';
import 'assert';
import 'stream';
import 'querystring';
import 'url';
...
var displaySummaryForValidationResults = function displaySummaryForValidationResults(name, resultsOrNone) {
  var results = resultsOrNone || [];
  ...
  console.log("".concat(results.length, " ").concat(name, "(s)"));
  _.each(summary, function (count, resultCode) {
    return console.log("\t".concat(resultCode, ": ").concat(count));
  });
};
var displaySummary = function displaySummary(result, depth) {
  ...
  if (result.warnings.length > 0 || result.errors.length > 0) {
    console.log("".concat(require$$1__default.inspect({
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          swaggerMockValidator = SwaggerMockValidatorFactory.create((_options$user = options.user) !== null && _options$user !== void 0 ? _options$user : options.token);
          _context.next = 5;
        ...
        case 10:
          ...
          logErrorAndExitProcess(_context.t0);
        case 13:
        case "end":
